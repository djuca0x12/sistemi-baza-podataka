...
using Poljoprivredno_gazdinstvo.Mapiranja;
    ...
    public class DataLayer
    {
        ...
        private static ISessionFactory CreateSessionFactory()
        {
            ...
            catch (Exception ec)
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show("Stvarna greška: " + ec.InnerException.Message);
                }
                else
                {
                    System.Windows.Forms.MessageBox.Show("Glavna greška: " + ec.Message);
                }
                return null;
            }
